...
@Component({
  selector: 'app-accordian-levels',
  templateUrl: './accordian-levels.component.html',
  styleUrls: ['./accordian-levels.component.scss'],
})
export class AccordianLevelsComponent implements OnInit {
