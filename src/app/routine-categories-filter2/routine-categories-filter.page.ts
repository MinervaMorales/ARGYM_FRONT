...
export class RoutineCategoriesFilterPage implements OnInit {
  ...
  ngOnInit() {
    ...
    console.log("index")
    console.log(this.routineCategoryService.categoriesByMachine)
  ...
  public async showInfo(element){
    this.flag="hello there"
    console.log("--response--")
    console.log(this.routineByMachineAndCategory)
     ...
     console.log(this.routineByMachineAndCategory?.objModel)
