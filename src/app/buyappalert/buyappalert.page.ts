...
export class BuyappalertPage implements OnInit {
 ...
 dismiss(){
   ...
   buyAppAction() {
     this.modalController.dismiss();
     window.open("https://bit.ly/cc2_Workout", '_system', 'location=no');
   }
    
  navWhatsapp() {
    this.http.get<any>("https://dashboard.vtlabs.dev/whatsapp.php?product_name=workout&source=application", {
